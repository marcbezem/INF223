...
\&\&\arrow{dd}{F(G(f))}  \set{(x,t(x))\mid x\in X}\arrow{dl}{\pi_2} \\
\&\&I\\
...
\item Indexing versus typing, the equivalence of $[I\to\Set]$ and $\Set/I$
\item[NB] $[M\to\Gra]$ and $\Gra/M$ are in general not equivalent
 \end{enumerate}
