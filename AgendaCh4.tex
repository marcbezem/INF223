...
\begin{tikzcd}[ampersand replacement=\&]
X\arrow[swap]{ddr}{b}\arrow{rrrd}{a}\arrow{rd}[description]{\exists!k}\arrow[dotted]{rrd}\\
\& 
A_1 \arrow[swap]{r}{f_1}\arrow{d}{g_1}\&
A_2\arrow[swap]{r}{f_2}\arrow{d}{g_2}\&
A_3 \arrow{d}{g_3}\\
\&
B_1\arrow{r}{h_1} \&
B_2\arrow{r}{h_2} \&
...
\begin{tikzcd}[ampersand replacement=\&]
X\arrow[swap]{ddr}{b}\arrow[dashed, xshift=1mm]{rrrd}{a;f_2}
\arrow{rd}[description]{\exists!k}\arrow[swap, xshift=1mm]{rrd}{a}\\
\& 
A_1 \arrow[swap]{r}{f_1}\arrow{d}{g_1}\&
A_2\arrow[swap]{r}{f_2}\arrow{d}{g_2}\&
A_3 \arrow{d}{g_3}\\
...
%with a configuation of objects and morphisms
...
\item Revisit: product sl.\ref{Ch4:Prod}, final object sl.\ref{Ch4:FinalObj}, equalizer sl.\ref{Ch4:PullbProdEq}, pullback sl.\ref{Ch4:PullPush}
...
\item Revisit: sum sl.\ref{Ch4:EqCoEq}, initial object sl.\ref{Ch4:InitialObj}
...
\frame
  {   
    \frametitle{Equalizer and coequalizer compared}\label{Ch4:EqCoEq}
...
\begin{tikzcd}[ampersand replacement=\&]
%X\arrow{dr}{h;m}\arrow[swap]{d}{h}\\ 
A\arrow[bend left]{r}{f}\arrow[bend right]{r}{g}\&B  \arrow{r}{n} \& C
\end{tikzcd} (why?)
\item Co(co)ne:
\begin{tikzcd}[ampersand replacement=\&]
%X\arrow{dr}{h;m}\arrow[swap]{d}{h}\\ 
\&E \arrow[swap]{dl}{m}\arrow{dr}{m;f} \&
~A\arrow[swap]{dr}{f;n}\arrow[bend left]{rr}{f}\arrow[bend right]{rr}{g}\&
\&B\arrow{dl}{n}\\
A\arrow[bend left]{rr}{f}\arrow[bend right]{rr}{g}\&\&B~ \& C
\end{tikzcd}
\item 
\begin{tikzcd}[ampersand replacement=\&]
X\arrow{dr}{h}\arrow{d}[description]{\exists!k}\\ 
...
\begin{tikzcd}[ampersand replacement=\&]
\&\&X\\ 
A\arrow[bend left]{r}{f}\arrow[bend right]{r}{g}\&
B  \arrow{r}{n}\arrow{ur}{h} \&
C
\arrow{u}[description]{\exists!k}
\end{tikzcd}
\item
In $\Set$, %\left\{
$E=\set{a\in A\mid f(a)=g(a)}$. What is $C$?
...
%This boild down to $h(b)=h(b')$ if $b\sim b'$.
\vspace*{2mm}
...
A\arrow{d}{f}
\&
C \arrow[swap]{r}{f}\arrow{d}{g}\&
A\arrow[swap]{d}{\kappa_1}\arrow{rdd}{h_1}\\
\&
B\arrow{r}{g} \&
C
\&
B\arrow{r}{\kappa_2}\arrow[swap]{drr}{h_2} \&
D\arrow{rd}[description]{\exists!k}
\\
\&\&\&\&\&Y
\end{tikzcd}  
...
\begin{tikzcd}[ampersand replacement=\&]
\& A\arrow[swap]{dr}{\kappa_1}\\
C\arrow[swap]{ur}{f}\arrow{dr}{g}\&\&
A+B  \arrow{r}{n} \& P \\
\& B\arrow{ur}{\kappa_2}
\end{tikzcd}
...
\end{tikzcd}\] 
Now define: % (explanation follows):
$X = A\times B\times A\times C$ and $Y = B\times A \times A$,
and equalizer
\begin{tikzcd}[ampersand replacement=\&]
L \arrow{r}{m}\&
X\arrow[bend left]{rr}{\Kp{\pi_2,\pi_1,\pi_3}}
\arrow[swap, bend right]{rr}{\Kp{\pi_1;f,\pi_2;g,\pi_2;h}}\&\&Y
\end{tikzcd}
