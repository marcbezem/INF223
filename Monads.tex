...
\frame
  {   
    \frametitle{Categorical abstraction from the Writer (three)}\label{Mon5:CatAbstrThree}
...
\item Exercise: prove that the Haskell monad laws hold
 \end{itemize}
